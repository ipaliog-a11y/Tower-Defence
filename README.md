...
| Path | What |
|------|------|
| `godot/` | **Main project** — Godot 4 vertical slice (open this) |
| `mockup/` | Browser prototype (design reference) |
| `Grid_and_Decay_Design_Document.md` | Design notes |
| `Paper_Play_Spine_District.md` | Early paper rules |
